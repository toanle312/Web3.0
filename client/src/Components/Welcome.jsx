        ...
        <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
          ...
          <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
              <div className="flex justify-between flex-col w-full h-full">
                <div className="flex justify-between items-start">
                  ...
                  <Popover content={"More about Ethereum"} trigger="hover" arrow={0} >
                    <a href="https://ethereum.org"><BsInfoCircle fontSize={17} color="#fff" /></a>
                  </Popover>
                </div>
                ...
                <div>
                  ...
                  <p className="text-white font-light text-sm mt-1">
                    You are not connected to the MetaMask Wallet
                  </p>}
            ...
            <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
              ...
              {isLoading ? <Loader type="small" /> : <button
                type="button"
